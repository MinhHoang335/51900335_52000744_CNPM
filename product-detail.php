...
<div class="jumbotron">
  <h2 class="text-center mt-5">Thông tin chi tiết</h2>
</div>
    ...
    <section class="my-5">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <p><span class="mr-1"><strong>Giá Thuê  <?php echo $price; ?> Vnd/Ngày</strong></span></p>
          <p><span class="mr-1"><strong>Màu Xe : <?php echo $mau; ?></strong></span></p>
          <p><span class="mr-1"><strong>Số     : <?php echo $so; ?> </strong></span></p>
          <p class="pt-1"><?php echo $detail; ?></p>
          <div class="table-responsive">
            <table class="table table-borderless mb-0">
              <tbody>
                <tr>
                  <th class="pl-0 w-25" scope="row"><strong>Số Lượng Ghế</strong></th>
                  <td><?php echo $size; ?></td>
                </tr>
          ...
          <form method="post">
            ...
            if (isset($_SESSION['email'])) {
              ...
              if (isset($_POST['submit'])) {
                ...
                if (mysqli_num_rows($run_cart) == 0) {
                  $cart_query = "INSERT INTO `cart`(`cust_id`, `product_id`,quantity,bdate,rdate) VALUES ('$custid','$p_id','$qty','$bdate','$rdate')";
                  if (mysqli_query($con, $cart_query)) {
                    header("location:product-detail.php:72?product_id=$p_id");
                  }
                }
            ...
            <div class="form-group">
              ...
              <input type="number" name="qty" placeholder="Quantity" value="1" class="form-control w-25"><br>
              <label>Ngày Bắt Đầu</label>
              <input type="date" name="bdate" placeholder="ENTER THE DATE FOR BOOKING">
              <br><br>

              <label>Ngày Kết Thúc</label>
              <input type="date" name="rdate" placeholder="Enter The Return Date">
